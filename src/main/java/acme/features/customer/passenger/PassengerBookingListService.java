...
@GuiService
public class PassengerBookingListService extends AbstractGuiService<Customer, Passenger> {
	...
	public void authorise() {
		...
		booking = this.passengerRepository.findBookingById(masterId);
	...
	public void load() {
		...
		passengers = this.passengerRepository.findPassengersByBookingId(id);
