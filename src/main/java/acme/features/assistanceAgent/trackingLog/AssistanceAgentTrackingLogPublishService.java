...
public class AssistanceAgentTrackingLogPublishService extends AbstractGuiService<AssistanceAgent, TrackingLog> {
	...
	public void authorise() {
		...
		authorised = trackingLog != null && !trackingLog.getIsPublished() && trackingLog.getTrackingSteps() != null && trackingLog.getTrackingSteps().getCIsAccepted() && trackingLog.getTrackingSteps().getRegisteredBy() != null
