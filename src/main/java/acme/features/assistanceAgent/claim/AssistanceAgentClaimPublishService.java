...
public class AssistanceAgentClaimPublishService extends AbstractGuiService<AssistanceAgent, Claim> {
	...
	public void authorise() {
		...
		if (super.getRequest().hasData("id")) {
			...
			authorised = claim != null && !claim.getCIsAccepted() && !claim.getStatus().equals(ClaimStatus.PENDING) && claim.getRegisteredBy() != null && super.getRequest().getPrincipal().hasRealm(claim.getRegisteredBy());
		} else
			authorised = false;
